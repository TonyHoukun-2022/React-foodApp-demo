...
const AvailableMeals = () => {
  ...
  useEffect(() => {
    ...
    const fetchMeals = async () => {
      // get request
      const response = await fetch("https://foodapp-253e6-default-rtdb.firebaseio.com/meals.jso")
    ...
    //fetchMeals returns a promise, promise.then(success func), promise.catch(errorfunc)
